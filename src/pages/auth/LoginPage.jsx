...
const DEMO_ACCOUNTS = [
    { label: 'Administrateur', email: 'amina.benali@sonatrach.dz' },
    { label: 'Responsable IT', email: 'karim.meziani@sonatrach.dz' },
    { label: 'Technicien IT', email: 'tarek.ouldali@sonatrach.dz' },
    { label: 'Employé', email: 'hamza.yahiaoui@sonatrach.dz' },
    { label: 'Auditeur', email: 'sarah.azzouz@sonatrach.dz' },
]
            ...
            <div className="hidden lg:flex w-1/2 flex-col justify-between p-12 bg-dark-surface relative overflow-hidden">
                ...
                <div className="z-10 text-white">
                    <div className="flex items-center gap-3 mb-16">
                        ...
                        <span className="text-xl font-display font-bold tracking-wider">SONATRACH</span>
                    </div>

                    <h1 className="text-5xl font-display font-bold mb-6 leading-tight">
                        Système Intégré de Gestion<br />du Matériel Informatique
                    </h1>
                    <p className="text-lg text-gray-400 max-w-md font-light">
                        Gérez l'ensemble du cycle de vie du parc informatique, des logiciels et de la maintenance avec précision et efficacité.
                    </p>
                </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12">
                ...
                >
                    ...
                    <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-8 shadow-sm">
                        <h2 className="text-2xl font-display font-bold mb-2">Connexion à SIGMA</h2>
                        <p className="text-sm text-[var(--color-muted)] mb-8">Veuillez vous authentifier pour accéder à votre espace.</p>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                            ...
                            <div className="flex items-center justify-between py-2">
                                <label className="flex items-center gap-2 cursor-pointer">
                                    <input type="checkbox" className="rounded border-gray-300 text-sonatrach-green focus:ring-sonatrach-green/20" />
                                    <span className="text-sm text-[var(--color-muted)]">Se souvenir de moi</span>
                                </label>
                                <a href="#" className="text-sm text-sonatrach-green hover:underline">Mot de passe oublié ?</a>
                            </div>
                        ...
                        <div className="mt-8 pt-6 border-t border-[var(--color-border)]">
                            <p className="text-xs text-[var(--color-muted)] mb-3 uppercase tracking-wider font-semibold">Comptes de test (cliquez pour remplir)</p>
                            ...
                            <p className="text-xs text-[var(--color-muted)] mt-3">Mot de passe pour tous : <code>sigma2024</code></p>
                        </div>
                    </div>
                </motion.div>
            </div>
