...
export default function FormFicheBesoin() {
    ...
    useEffect(() => { const s = localStorage.getItem(DRAFT_KEY); if (s) { try { const d = JSON.parse(s); if (d.formData) reset(d.formData); if (d.articles) setArticles(d.articles) } catch { } } }, [reset])
