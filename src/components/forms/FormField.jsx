...
export const FormField = ({ label, name, register, errors, required, type = 'text', placeholder, disabled, className, ...rest }) => {
    ...
    return (
        <div className={cn('space-y-1', className)}>
            ...
            <input
                ...
                className={cn(
                    'w-full h-9 px-3 rounded-lg border text-sm bg-transparent outline-none transition-all',
